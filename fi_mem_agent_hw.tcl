...
# Sun Feb 09 18:33:33 GMT+04:00 2014
# DO NOT MODIFY


# 
# fi_mem_agent "fi_mem_agent" v5.0
# Mamoutova 2014.02.09.18:33:33
...
set_fileset_property SIM_VERILOG TOP_LEVEL fi_mem_agent
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file fi_mem_agent.vhd VHDL PATH hdl/fi_mem_agent.vhd


# 
# parameters
# 
add_parameter use_ack BOOLEAN true "use_ack = 0 - two-cycle read/one-cycle write"
set_parameter_property use_ack DEFAULT_VALUE true
set_parameter_property use_ack DISPLAY_NAME "USE ACKNOWLEDGE"
set_parameter_property use_ack TYPE BOOLEAN
set_parameter_property use_ack UNITS None
...
set_interface_property original_interface isMemoryDevice true
...
add_interface_port original_interface RD read Input 1
...
add_interface_port memory_interface RD_m read Output 1
...
add_interface_port conduit_end fi_rd export Input 1
